...
int main(int argc, char* argv[])
{
    ...
    //Testing Select OR
    // std::cout<<"TESTING SELECT_OR"<<std::endl;

    // sheet.set_selection(
    //     new Select_Or(
    //         new Select_Contains(&sheet,"Major","mathematics"),
    //         new Select_Contains(&sheet,"Major","computer science")
    //         )
    // );

    // sheet.print_selection(std::cout);
    // std::cout<<"SELECTION_OR TEST ENDED"<<std::endl;

    // std::cout<<"TESTING SELECT_AND"<<std::endl;

    // sheet.set_selection(
    //     new Select_And(
    //         new Select_Contains(&sheet,"Age","21"),
    //         new Select_Contains(&sheet,"Major","")
    //         )
    // );

    // sheet.print_selection(std::cout);
    // std::cout <<"SELECTION_AND TEST ENDED"<<std::endl;
    ...
    // sheet.set_selection(new Select_Not(
    //             new Select_Contains(&sheet,"First","")));
    // sheet.print_selection(std::cout);
    // std::cout << std::endl;
